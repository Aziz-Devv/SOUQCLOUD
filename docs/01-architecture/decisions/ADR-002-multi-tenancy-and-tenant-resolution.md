...
Related Documents: docs/01-architecture/multi-tenancy.md, docs/02-database/schema-overview.md
Decisions: Shared database with logical tenant isolation via PostgreSQL Row Level Security (RLS) & Composite Foreign Keys; hostname resolution via Next.js 16 proxy.ts on Node.js runtime fronted by Cloudflare Edge.
Open Questions: None
